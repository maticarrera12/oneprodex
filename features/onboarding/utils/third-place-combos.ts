// Auto-generated from FIFA 2026 official regulations (Annex C) — 495 combinations.
// Key: 8 qualifying third-place groups, sorted A→L (e.g. "ABCDEFGH").
// Value tuple: [P11, P15, P7, P1, P8, P2, P16, P12]
//   where each element is the GROUP letter of the 3rd-place team for that slot.
// Slot ↔ match:  P1=M74(1°E), P2=M77(1°I), P7=M81(1°D), P8=M82(1°G),
//                P11=M79(1°A), P12=M80(1°L), P15=M85(1°B), P16=M87(1°K)
export const THIRD_PLACE_COMBOS: Record<string, readonly [string,string,string,string,string,string,string,string]> = {
